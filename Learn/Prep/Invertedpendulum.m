...
AUTO = 1;
DISTURB = 1; % 0:NO, 1:NOISE, 2:CONST
LINEAR = 1;
CARRUN = 0;
...
text(0,2,'Distance','FontSize',12,'HorizontalAlignment','center','VerticalAlignment','bottom');
text(0,1.8,'Velocity','FontSize',12,'HorizontalAlignment','center','VerticalAlignment','bottom');
text(0,1.6,'Acceleration','FontSize',12,'HorizontalAlignment','center','VerticalAlignment','bottom');
text(0,1.4,'Disturbance','FontSize',12,'HorizontalAlignment','center','VerticalAlignment','bottom');
